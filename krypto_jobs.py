...
# YOUR CODE HERE
from crypto_wallet import generate_account, get_balance, send_transaction, Web3
################################################################################
...
if st.sidebar.button("Send Transaction"):
    gasprice = 50
    transaction_hash = send_transaction(account, candidate_database[person][1], wage, gasprice)
